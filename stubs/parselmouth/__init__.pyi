...
class MFCC(CC):
    ...
    def cross_correlate(self, other: MFCC, scaling: AmplitudeScaling = ..., signal_outside_time_domain: SignalOutsideTimeDomain = ...) -> Sound:
        ...
    def extract_features(self, window_length: Positive[float] = 0.025, include_energy: bool = False) -> Matrix:
        ...
    def to_matrix_features(self, window_length: Positive[float] = 0.025, include_energy: bool = False) -> Matrix:
        ...
...
class Pitch(TimeFrameSampled, Sampled):
    ...
    def octave_up(self, from_time: float | None = None, to_time: float | None = None) -> None:
        ...
    def path_finder(self, silence_threshold: float = 0.03, voicing_threshold: float = 0.45, octave_cost: float = 0.01, octave_jump_cost: float = 0.35, voiced_unvoiced_cost: float = 0.14, ceiling: Positive[float] = 600.0, pull_formants: bool = False) -> None:
        ...
    def smooth(self, bandwidth: Positive[float] = 10.0) -> Pitch:
        ...
    def step(self, step: float, precision: Positive[float] = 0.1, from_time: float | None = None, to_time: float | None = None) -> None:
        ...
    ...
    def to_sound_pulses(self, from_time: float | None = None, to_time: float | None = None) -> Sound:
        ...
    def to_sound_sine(self, from_time: float | None = None, to_time: float | None = None, sampling_frequency: Positive[float] = 44100.0, round_to_nearest_zero_crossing: float = True) -> Sound:
        ...
...
class Sound(TimeFrameSampled, Vector):
    ...
    def combine_to_stereo(sounds: list[Sound]) -> Sound:
        ...
    @staticmethod
    def concatenate(sounds: list[Sound], overlap: NonNegative[float] = 0.0) -> Sound:
        ...
    ...
    def de_emphasize(self, from_frequency: float = 50.0, normalize: bool = True) -> None:
        ...
    def deepen_band_modulation(self, enhancement: Positive[float] = 20.0, from_frequency: Positive[float] = 300.0, to_frequency: Positive[float] = 8000.0, slow_modulation: Positive[float] = 3.0, fast_modulation: Positive[float] = 30.0, band_smoothing: Positive[float] = 100.0) -> Sound:
        ...
    ...
    def extract_left_channel(self) -> Sound:
        ...
    def extract_part(self, from_time: float | None = None, to_time: float | None = None, window_shape: WindowShape = ..., relative_width: Positive[float] = 1.0, preserve_times: bool = False) -> Sound:
        ...
    def extract_part_for_overlap(self, from_time: float | None = None, to_time: float | None = None, overlap: Positive[float]) -> Sound:
        ...
    ...
    def get_time_from_index(self, sample: int) -> float:
        ...
    def lengthen(self, minimum_pitch: Positive[float] = 75.0, maximum_pitch: Positive[float] = 600.0, factor: Positive[float]) -> Sound:
        ...
    ...
    def set_to_zero(self, from_time: float | None = None, to_time: float | None = None, round_to_nearest_zero_crossing: bool = True) -> None:
        ...
    def to_formant_burg(self, time_step: Positive[float] | None = None, max_number_of_formants: Positive[float] = 5.0, maximum_formant: float = 5500.0, window_length: Positive[float] = 0.025, pre_emphasis_from: Positive[float] = 50.0) -> Formant:
        ...
    def to_harmonicity(self, method: Sound.ToHarmonicityMethod = ..., *args, **kwargs) -> typing.Any:
        ...
    def to_harmonicity_ac(self, time_step: Positive[float] = 0.01, minimum_pitch: Positive[float] = 75.0, silence_threshold: float = 0.1, periods_per_window: Positive[float] = 1.0) -> Harmonicity:
        ...
    def to_harmonicity_cc(self, time_step: Positive[float] = 0.01, minimum_pitch: Positive[float] = 75.0, silence_threshold: float = 0.1, periods_per_window: Positive[float] = 1.0) -> Harmonicity:
        ...
    def to_harmonicity_gne(self, minimum_frequency: Positive[float] = 500.0, maximum_frequency: Positive[float] = 4500.0, bandwidth: Positive[float] = 1000.0, step: Positive[float] = 80.0) -> Matrix:
        ...
    def to_intensity(self, minimum_pitch: Positive[float] = 100.0, time_step: Positive[float] | None = None, subtract_mean: bool = True) -> Intensity:
        ...
    def to_mfcc(self, number_of_coefficients: Positive[int] = 12, window_length: Positive[float] = 0.015, time_step: Positive[float] = 0.005, firstFilterFreqency: Positive[float] = 100.0, distance_between_filters: Positive[float] = 100.0, maximum_frequency: Positive[float] | None = None) -> MFCC:
        ...
    def to_pitch(self, time_step: Positive[float] | None = None, pitch_floor: Positive[float] = 75.0, pitch_ceiling: Positive[float] = 600.0) -> ...:
        """
        to_pitch(self: parselmouth.Sound, method: parselmouth.Sound.ToPitchMethod, *args, **kwargs) -> object
        """
    def to_pitch_ac(self, time_step: Positive[float] | None = None, pitch_floor: Positive[float] = 75.0, max_number_of_candidates: Positive[int] = 15, very_accurate: bool = False, silence_threshold: float = 0.03, voicing_threshold: float = 0.45, octave_cost: float = 0.01, octave_jump_cost: float = 0.35, voiced_unvoiced_cost: float = 0.14, pitch_ceiling: Positive[float] = 600.0) -> Pitch:
        ...
    def to_pitch_cc(self, time_step: Positive[float] | None = None, pitch_floor: Positive[float] = 75.0, max_number_of_candidates: Positive[int] = 15, very_accurate: bool = False, silence_threshold: float = 0.03, voicing_threshold: float = 0.45, octave_cost: float = 0.01, octave_jump_cost: float = 0.35, voiced_unvoiced_cost: float = 0.14, pitch_ceiling: Positive[float] = 600.0) -> Pitch:
        ...
    def to_pitch_shs(self, time_step: Positive[float] = 0.01, minimum_pitch: Positive[float] = 50.0, max_number_of_candidates: Positive[int] = 15, maximum_frequency_component: Positive[float] = 1250.0, max_number_of_subharmonics: Positive[int] = 15, compression_factor: Positive[float] = 0.84, ceiling: Positive[float] = 600.0, number_of_points_per_octave: Positive[int] = 48) -> Pitch:
        ...
    def to_pitch_spinet(self, time_step: Positive[float] = 0.005, window_length: Positive[float] = 0.04, minimum_filter_frequency: Positive[float] = 70.0, maximum_filter_frequency: Positive[float] = 5000.0, number_of_filters: Positive[int] = 250, ceiling: Positive[float] = 500.0, max_number_of_candidates: Positive[int] = 15) -> Pitch:
        ...
    def to_spectrogram(self, window_length: Positive[float] = 0.005, maximum_frequency: Positive[float] = 5000.0, time_step: Positive[float] = 0.002, frequency_step: Positive[float] = 20.0, window_shape: SpectralAnalysisWindowShape = ...) -> Spectrogram:
        ...
...
class Spectrogram(TimeFrameSampled, Matrix):
    def get_power_at(self, time: float, frequency: float) -> float:
        ...
    def synthesize_sound(self, sampling_frequency: Positive[float] = 44100.0) -> Sound:
        ...
    def to_sound(self, sampling_frequency: Positive[float] = 44100.0) -> Sound:
        ...
...
class Spectrum(Matrix):
    def __getitem__(self, index: int) -> complex:
        ...
    def __init__(self, values: numpy.ndarray[numpy.float64], maximum_frequency: Positive[float]) -> ...:
        """
    ...
    def __setitem__(self, index: int, value: complex) -> None:
        ...
    def cepstral_smoothing(self, bandwidth: Positive[float] = 500.0) -> Spectrum:
        ...
    ...
    def get_bin_width(self) -> float:
        ...
    def get_center_of_gravity(self, power: Positive[float] = 2.0) -> float:
        ...
    def get_central_moment(self, moment: Positive[float], power: Positive[float] = 2.0) -> float:
        ...
    def get_centre_of_gravity(self, power: Positive[float] = 2.0) -> float:
        ...
    ...
    def get_imaginary_value_in_bin(self, bin_number: Positive[int]) -> float:
        ...
    def get_kurtosis(self, power: Positive[float] = 2.0) -> float:
        ...
    ...
    def get_real_value_in_bin(self, bin_number: Positive[int]) -> float:
        ...
    def get_skewness(self, power: Positive[float] = 2.0) -> float:
        ...
    def get_standard_deviation(self, power: Positive[float] = 2.0) -> float:
        ...
    def get_value_in_bin(self, bin_number: Positive[int]) -> complex:
        ...
    def lpc_smoothing(self, num_peaks: Positive[int] = 5, pre_emphasis_from: Positive[float] = 50.0) -> Spectrum:
        ...
...
class TimeFrameSampled(TimeFunction, Sampled):
    def frame_number_to_time(self: Sampled, frame_number: Positive[int]) -> float:
        ...
    def get_frame_number_from_time(self: Sampled, time: float) -> float:
        ...
    def get_number_of_frames(self: Sampled) -> int:
        ...
    def get_time_from_frame_number(self: Sampled, frame_number: Positive[int]) -> float:
        ...
...
class TimeFunction(Function):
    ...
    def get_total_duration(self: Function) -> float:
        ...
    def scale_times_by(self: Function, scale: Positive[float]) -> None:
        ...
...
class Vector(Matrix):
    ...
    def scale(self, scale: Positive[float]) -> None:
        ...
    def scale_peak(self, new_peak: Positive[float] = 0.99) -> None:
        ...
