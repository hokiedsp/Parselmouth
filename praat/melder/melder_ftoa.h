...
inline auto fmt_snprintf(char *out, size_t n, const S &format_str, const Args &... args) {
	return static_cast<int>(fmt_vsnprintf(out, n, fmt::detail::to_string_view(format_str), fmt::make_printf_args(args...)));
}
...
inline int fmt_sprintf(char *out, const S &format_str, const Args &... args) {
	return static_cast<int>(fmt_vsprintf(out, fmt::detail::to_string_view(format_str), fmt::make_printf_args(args...)));
}
